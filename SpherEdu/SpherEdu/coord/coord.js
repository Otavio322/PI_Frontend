// =============================================
//  SpherEdu – Coordenador · coord.js
//  SPA com Dashboard, Alunos, Regras, Certificados
// =============================================
...
// Fake certificate image (base64 placeholder – we use a generated SVG as data URL)
...
function abrirReview(i) {
  ...
  // Certificate image (use same CERT_DATA_URL for all in this demo)
