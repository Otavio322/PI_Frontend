/**
 * app.js – SpherEdu Super Admin
 * Lógica principal: navegação, renderização de tabelas, modais.
 * TODO: substituir chamadas MOCK.* por fetch() à API quando o backend estiver pronto.
 * Padrão de chamada previsto: import { api } from './api.js';
 */
...
function editCurso(id) {
  ...
  // preenche o modal de entidade funcional
...
function deleteCurso(id) {
  ...
  document.getElementById('confirmBtn').onclick = () => {
    ...
    // TODO: fetch DELETE /api/cursos/:id
  };
...
function deleteCoord(id) {
  ...
  document.getElementById('confirmBtn').onclick = () => {
    ...
    // TODO: fetch DELETE /api/coordenadores/:id
  };
  openModal('modalConfirm');
}
...
function salvarCoord() {
  ...
  if (editingCoordId) {
    ...
    // TODO: fetch PUT /api/coordenadores/:id
  } else {
    ...
    // TODO: fetch POST /api/coordenadores
  }
  renderCoordenadores();
...
function filtrarLogs() {
  ...
  // TODO: fetch GET /api/logs?evento=&coord=&data=
}

function exportarLog() {
  showToast('Exportação iniciada – funcionalidade conectará à API em breve.');
  // TODO: fetch GET /api/logs/export → download CSV
}
